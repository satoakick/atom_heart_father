require "config"
environment = ENV["RACK_ENV"] == "deployment" ? "production" : ENV["RACK_ENV"]
...
socket_path = environment == "development" ? "#{ROOT_DIR}/tmp/sockets/unicorn.sock" : "#{ROOT_DIR}/shared/tmp/sockets/unicorn.sock"
listen socket_path, :backlog => Settings.unicorn.backlog
